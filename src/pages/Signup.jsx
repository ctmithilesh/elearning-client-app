              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  <input
                    ...
                    onChangeCapture={(e) => setFormData({ ...formData, first_name: e.target.value })}
                  />
                  {errors.first_name && <small className="text-red-400">This field is required</small>}
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  <input
                    ...
                    onChangeCapture={(e) => setFormData({ ...formData, last_name: e.target.value })}
                  />
                  {errors.last_name && <small className="text-red-400">This field is required</small>}
                  <span className="absolute right-4 top-4">
                    <svg
                      className="fill-current"
                      width="22"
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  <select
                    ...
                    onChangeCapture={(e) => setFormData({ ...formData, role: e.target.value })}
                  >
